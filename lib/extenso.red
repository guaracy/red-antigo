...
to-extenso: function [ valor [integer! float!] /km /kg][
   ...
   foreach v vmat [
      ;      if (not km) and (not kg) and (i = 1) and (v = 0) and (ext <> "")[
      ;         append ext " reais "
      ;      ]
      ;append ext to-extenso-centena ext v i unidades
      to-extenso-centena ext v i unidades
      if (i = 2) and (v = 0) and ((to integer! valor) > 1) [append ext " reais "]
      ix: ix + 1
      ;; if i = 1 [
      ;;    if (not km) and (not kg) and (ext <> "") [
      ;;       if vmat/(ix - 1) = 0 [
      ;;          print [">>>" v vmat/(ix - 1)]
      ;;          append ext " reais "
      ;;       ]
