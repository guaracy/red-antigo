...
\textbf{\#}. Para representarmos o caractere \texttt{"A"} usamos \ttfamily{\#"A"}\normalfont.
Para representar caracteres com valores menor que 32 (espaço), prefixamos com um
sinal circunflexo. Para o caractere 27 (escape) temos
\ttfamily{\#"\^{}["}\normalfont. 
