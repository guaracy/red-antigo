...
matrix que pode conter qualquer coisa. Podemos efetuar operações em um bloco ou
mesmo entre blocos. Por exemplo:
...
Também são permitidas operações sobre os pares. Um par irá afetar os valores
individualmente \codigo{2x5 + 2 $\rightarrow$ 4x7}. Se o operedor for um par,
...
Armazenam pares de valores, geralmente utilizados em coordenadas cartesianas.
Informamos os dois valores (x e y) separados por um \codigo{x} minúsculo.

\codigo{nota: por enquanto não aceita decimais}
